...
game_over_text = canvas.create_text(500, 650, text='YOU ARE FU*KIN\' LOSER, GET THE HELL OUT OF HERE DUDE!!', state='hidden',
...
while True:
    ...
    if ball.hit_bottom == True:
        ...
        canvas.create_image(5, 300, anchor=NW, image=my_image2)
        break
